...
require_once __DIR__.'/lib/race_import.php';
...
{
	$sql = "SELECT id, ext_id, datum, datum2, nazev, misto, typ0, typ, zebricek, ranking, odkaz, prihlasky, prihlasky1, prihlasky2, prihlasky3, prihlasky4, prihlasky5, transport_do, ubytovani_do,  etap, oddil, kategorie, vicedenni, cancelled, entry_start, modify_flag"
